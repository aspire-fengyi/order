...
<section id="getintouch" class="bounceIn animated">
    ...
    <div class="container">
        <form class="contact" action="<?php echo route('home.addr.add',['id'=>session('homeUser')['id']]); ?>" method="post" >
            ...
            <div class="row clearfix">
                ...
                <div class="ctrl">
                    <input type="text" id="name" name="addr_name" required=""   placeholder="请输入收件人姓名" value="{{old('addr_name')}}">
                </div>
            </div>
            ...
            <div class="row clearfix">
                ...
                <div class="ctrl">
                    <input type="text" id="phone" name="addr_phone" required=""  placeholder="请输入收件人手机号" value="{{old('addr_phone')}}">
                </div>
            </div>
            <div class="row clearfix">
                <div class="lbl">
                ...
                <div class="ctrl">
                    <input type="text" name="addr" id="addr"  required=""   placeholder="请输入详细地址,例:北京市,通州区,宋庄,创意工厂科技有限公司" value="{{old('addr')}}">
                </div>
            </div>

            <div class="row  clearfix">
                <div class="span10 offset2">
                    <input type="submit" name="submit" id="" class="submit" value="提交地址">
                </div>
            </div>
        </form>
