...
<div class="top">
    <div class="wt1080">
        <div class="fl">
            <a href="index.html">商城首页</a>&emsp;|&emsp;请&emsp;<a href="#" style="color: #ff9900">登陆</a>&emsp;或&emsp;<a href="#">立即注册</a>
        </div>
        <div class="fr">
            <ul>
                ...
                <li><span class="shop">购物车<a href="gouwuche.html">0</a>件</span></li>
...
<div class="wt1080 header">
    ...
    <a class="my_shop fr" href="gouwuche.html">我的购物车<span>2</span></a>
    <div class="clear"></div>
</div>
<!--------------导航------------------>
<div class="nav">
