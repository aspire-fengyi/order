        ...
        <div class="panel-body">
            <form action="<?php echo route('admin.users.add');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="checkbox-inline"><label><input name="sex" type="radio" value="1"> 男</label></div>
                        <div class="checkbox-inline"><label><input name="sex" type="radio" value="2"> 女</label></div>
                        <div class="checkbox-inline"><label><input name="sex" type="radio" value="0"> 保密</label></div>
                    </div>
                </div>
