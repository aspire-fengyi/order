...
@section('mulu')
    ...
    <li class="breadcrumb-item"><a href="<?php echo route('admin.index'); ?>">首页</a><i class="fa fa-angle-right"></i>产品管理 <i class="fa fa-angle-right"></i>产品颜色添加</li>
...
@section('content')
    ...
    <div class="grid-form1">
        ...
        <div class="panel-body">
            <form action="<?php echo route('admin.goods.goodColorAdd', ['id' => $good_id]);?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}
